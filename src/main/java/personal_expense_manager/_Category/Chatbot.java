...
//Declare a reference of reportService by calling a different method to calculate reports
	...
	// Declare a reference of fileService by calling a different method to buffer
	// written user input to .txt's
	...
	public void showMenu() {
		while (true) {
			try {
				...
				// This catch with prompt the print statements contents whenever a user inputs
				// Invalid prompts
...
// and wait for any char input to continue to the menu
	...
	// This method to taking expense category name as input to add caategory in the
	// system
	...
	// Call this method to enter expense detail. The entered details will be added
	// in repository.
...
// Means this method invokes a call to generate report then result is printed by this method     
	...
	// Using ReportService.java to calculate report.
	// The returned result is printed by this method.
	// Means this method invokes a call to generate report then result is printed by
	// this method
